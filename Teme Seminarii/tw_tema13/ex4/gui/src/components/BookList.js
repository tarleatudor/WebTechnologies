...
function BookList() {
  ...
  const [chartData, setChartData] = useState([["Title", "Page count"]]);
  ...
  return (
    <div>
      <Button
        ...
        onClick={() => setIsChartDialogShown(true)}
      />
      ...
      <Dialog
        ...
        onHide={() => setIsChartDialogShown(false)}
        style={{ width: "60vw" }}
      >
        <Chart
          chartType="BarChart"
      ...
      >
        ...
        <div>
          <InputText
            ...
            onChange={(evt) => setPageCount(Number(evt.target.value))}
            value={pageCount}
          />
        </div>
      </Dialog>
